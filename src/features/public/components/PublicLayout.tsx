...
export function PublicLayout({ children, portalHref }: PublicLayoutProps) {
  return (
    <div className="min-h-dvh bg-bg integrity-public-theme text-ink">
      {/* Scroll scrim: fades content into the background behind the floating header */}
      <div className="pointer-events-none fixed inset-x-0 top-0 z-30 h-28 bg-gradient-to-b from-bg via-bg/85 to-transparent" />
